...
- **GRPO** — упрощение PPO для LLM (см. [билет 20](#/20)).
...
- **RLHF** (Ouyang et al., 2022) — reward model + PPO. См. [билет 2](#/02);
- **DPO** (Rafailov et al., 2023) — прямая оптимизация на парах preference. См. [билет 9](#/09);
- **GRPO** (DeepSeek, 2024) — без value-сети, групповая нормализация. См. [билет 20](#/20);
