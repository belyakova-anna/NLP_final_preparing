...
- $\gamma \in \lbrack 0,\, 1)$ — дисконтирующий фактор.
...
$$V^\pi(s) = \mathbb{E}_a[r + \gamma V^\pi(s')], \quad Q^\pi(s,a) = \mathbb{E}\bigl[r + \gamma\, \mathbb{E}_{a^{\prime}}\bigl[Q^\pi(s', a')\bigr]\bigr].$$
